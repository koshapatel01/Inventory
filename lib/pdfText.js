...
// pdfjs-dist uses the browser's DOMMatrix internally for text-transform math
// even for plain text extraction (no rendering) — it's not provided by
// Node.js itself. Worked in some local Node versions that happen to ship it
// as a built-in global, but crashes ("DOMMatrix is not defined") on Vercel's
// runtime, which doesn't. A tiny, dependency-free polyfill covers it.
